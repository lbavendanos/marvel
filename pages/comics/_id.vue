    ...
    <v-container text-xs-center>
      ...
      <v-layout 
        ...
        <v-flex 
          ...
          pa-4>
          <v-container 
            v-if="comic.characters.available > 0" 
            class="white--text" 
            grid-list-lg 
            pa-0>
          ...
          <v-container 
            v-if="comic.creators.available > 0" 
            class="white--text" 
            grid-list-lg 
            pa-0>
            <h2 class="subheading red--text text-xs-left pb-1">
          ...
          <v-container 
            v-if="comic.stories.available > 0" 
            class="white--text" 
            grid-list-lg 
            pa-0>
            <h2 class="subheading red--text text-xs-left pb-1">
      ...
      <v-layout 
        ...
        <v-btn 
          ...
          large>BACK TO THE COMICS SECTION</v-btn>
      </v-layout>
    </v-container>
  </section>
</template>
